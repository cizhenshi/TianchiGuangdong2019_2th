...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_bbox=dict(type='SmoothL1Loss', beta=1.0 / 9.0, loss_weight=1.2)),
    ...
    bbox_head=[
        dict(
            ...
            loss_bbox=dict(type='SmoothL1Loss', beta=1.0, loss_weight=1.2)),
        dict(
            type='SharedFCBBoxHead',
            num_fcs=2,
            in_channels=256,
...
log_level = 'INFO'
work_dir = './work_dirs/coco_normal'

load_from = "./coco_model/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth"
# load_from = None
resume_from = None
workflow = [('train', 1)]

...
model = dict(
    ...
    backbone=dict(
            ...
            norm_cfg=norm_cfg,
            dcn=dict(
                modulated=True, deformable_groups=1, fallback_on_stride=False, groups=64),
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_r101_sbn'

# load_from = "./work_dirs/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth"
load_from = "./coco_model/cascade_mask_rcnn_r4_gcb_dconv_c3-c5_x101_32x4d_fpn_syncbn_1x_20190602-b4164f6b.pth"
# load_from = None

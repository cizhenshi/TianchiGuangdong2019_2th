...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=(data_root + 'annotations/train20.json', data_root + 'annotations/ML.json'),
        img_prefix=(data_root + 'train/', data_root + "./instaboost/ML/"),
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/normal.json',
        img_prefix=data_root + 'normal/',
        pipeline=test_pipeline))
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/3scale_coco_up'
